...
2. Download the BindAdmin source:

 $ git clone git://github.com/mrijkeboer/bindadmin.git
...
1. Modify the settings (SERVER, SERVERNAME and PASSWORD) at the top of the client:

 $ vi bindadmin/client/client.sh
